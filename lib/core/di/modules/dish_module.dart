...
void registerDishModule(GetIt getIt) {
  ...
  getIt.registerLazySingleton<GetDishDetails>(() => GetDishDetails(getIt<DishRepository>()));
  getIt.registerLazySingleton<GetComments>(() => GetComments(getIt<DishRepository>()));
  getIt.registerLazySingleton<AddComment>(() => AddComment(getIt<DishRepository>()));
  getIt.registerLazySingleton<RateDish>(() => RateDish(getIt<DishRepository>()));
}
